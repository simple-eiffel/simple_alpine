...
extern EIF_TYPED_VALUE F94_1439(EIF_REFERENCE);
...
EIF_TYPED_VALUE F94_1439 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 93, Current, 0, 0, 1470);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1007,0xFF01,0,0xFFFF};
		EIF_TYPE typres0;
