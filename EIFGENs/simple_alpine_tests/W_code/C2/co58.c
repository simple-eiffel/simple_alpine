...
extern EIF_TYPED_VALUE F58_924(EIF_REFERENCE);
extern EIF_TYPED_VALUE F58_925(EIF_REFERENCE);
extern EIF_TYPED_VALUE F58_926(EIF_REFERENCE);
extern EIF_TYPED_VALUE F58_927(EIF_REFERENCE);
...
RTOID (F58_924)
EIF_TYPED_VALUE F58_924 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 57, Current, 0, 0, 1001);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(57, Current, 1001);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(3833, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
	...
	tr1 = RTMS_EX_H("65000",5,892765232);
	ur1 = tr1;
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(216, 10))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur2 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(3129, "put", Result))(Result, ur1x, ur2x);
	RTHOOK(153);
...
RTOID (F58_925)
EIF_TYPED_VALUE F58_925 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 57, Current, 0, 0, 1002);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(57, Current, 1002);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000277, 0,0); /* Result */
...
RTOID (F58_926)
EIF_TYPED_VALUE F58_926 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 57, Current, 0, 0, 1003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(57, Current, 1003);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000277, 0,0); /* Result */
...
RTOID (F58_927)
EIF_TYPED_VALUE F58_927 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 57, Current, 0, 0, 1004);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(57, Current, 1004);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000277, 0,0); /* Result */
