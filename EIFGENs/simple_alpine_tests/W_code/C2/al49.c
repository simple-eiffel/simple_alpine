...
extern EIF_TYPED_VALUE F49_881(EIF_REFERENCE, EIF_TYPED_VALUE);
...
{
	GTCX
	RTOTC (F49_880,966,RTMS_EX_H("label",5,1634667884));
}

/* {ALPINE_LABEL}.for_ */
EIF_TYPED_VALUE F49_881 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "for_";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTCC(arg1, 48, l_feature_name, 1, eif_new_type(282, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("for",3,6713202);
	ur1 = tr1;
