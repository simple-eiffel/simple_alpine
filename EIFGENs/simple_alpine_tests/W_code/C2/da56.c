...
extern EIF_TYPED_VALUE F56_909(EIF_REFERENCE);
extern EIF_TYPED_VALUE F56_910(EIF_REFERENCE);
extern EIF_TYPED_VALUE F56_911(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F56_904,982,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 55, Current, 0, 0, 982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(55, Current, 982);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 55, Current, 0, 0, 983);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(55, Current, 983);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000179, 0,0); /* Result */
...
EIF_TYPED_VALUE F56_909 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F56_909,987,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F56_910 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F56_910,988,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F56_911 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F56_911,989,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
