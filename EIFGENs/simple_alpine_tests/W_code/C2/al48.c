...
extern EIF_TYPED_VALUE F48_877(EIF_REFERENCE);
extern EIF_TYPED_VALUE F48_878(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F48_879(EIF_REFERENCE);
...
/* {ALPINE_OPTION}.tag_name */
RTOID (F48_877)


EIF_TYPED_VALUE F48_877 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F48_877,963,RTMS_EX_H("option",6,24682094));
}
...
#define ur2 ur2x.it_r
	...
	RTCC(arg1, 47, l_feature_name, 1, eif_new_type(282, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ALPINE_OPTION}.selected */
EIF_TYPED_VALUE F48_879 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 47, Current, 0, 0, 964);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("selected",8,1203629924);
	ur1 = tr1;
