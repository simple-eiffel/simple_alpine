...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F21_493);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(498, dtype))(Current)).it_c1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 512);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F21_495 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F21_496 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 507);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F21_497 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 508);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F21_498 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 509);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F21_499 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 510);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
